...
export default function CardBox(props) {
  ...
  const { id, title, subheader, image, typography, seeDetails } = props.item;
  ...
  return (
    <Card className="card-box" sx={{ maxWidth: 345, marginLeft: "100px" }}>
      <CardHeader
        avatar={
      ...
      <CardActions disableSpacing>
        ...
        <ExpandMore aria-label="show more">
          <div
            onClick={() => {
              props.cartClick ? handleExpandClick(id) : handleExpandBuy(id);
            }}
          >
            {props.btn}
          </div>
